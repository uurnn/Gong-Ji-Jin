...
if __name__ == '__main__':
    ...
    kfold_train = np.zeros(train.shape[0])  # 新增
    ...
    for seed in seeds:
        ...
        kfold_train = kfold_train + temp / len(seeds)

    # # train['lgb_pred'] = kfold_train
    # # train[['id', 'lgb_pred']].to_csv('../result/lgb_train_result.csv', index=False)
    ...
    submit.to_csv('../result/' + 'lgb_2_result.csv', index=False)
